...
build: deps ## Build the main application
	@echo "=( Building AgentMesh Cortex..."
	go build -o bin/agentmesh cmd/agentmesh/main.go
	@echo " Build complete: bin/agentmesh"
...
run: build docker-up ## Build and run the main application
	@echo "=� Starting AgentMesh Cortex..."
	@sleep 3
	./bin/agentmesh
